        ...
        <div className="cardName-main">
            <div className={!selected ? "cardName" : "cardNameRed"} onClick={()=> setSelected(prevState => !prevState)}>
                ...
                <div className={!selected ? "cardName-weight" : "cardName-weightRed"}>
                    <div className="cardName-weight_number">0,5</div>
                ...
                <div className="cardName-title">
                    ...
                    <div className="cardName-title_medium">с фуа-гра</div>
                </div>
            </div>
            {!selected
                ? (
                <div className="footerCard">Чего сидишь? Порадуй котэ,<span className="footerCard-link"> купи.</span> </div>
            ) : (
